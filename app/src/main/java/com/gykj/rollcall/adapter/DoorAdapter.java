 ...
 */
public class DoorAdapter extends BaseQAdapter<LossBean.RecordsBean, LayoutLossItemBinding, MVViewHolder<LayoutLossItemBinding>> {
    public DoorAdapter(int layoutResId) {
        super(layoutResId);
    }
    @Override
